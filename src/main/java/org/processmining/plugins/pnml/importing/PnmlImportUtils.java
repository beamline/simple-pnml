...
public class PnmlImportUtils {
	...
	public Pnml importPnmlFromStream(InputStream input) throws Exception {

		FullPnmlElementFactory pnmlFactory = new FullPnmlElementFactory();
		return importPnmlFromStream(pnmlFactory, input);
	}

	public Pnml importPnmlFromStream(FullPnmlElementFactory pnmlFactory, InputStream input) throws Exception {
		/*
...
//		context.getFutureResult(1).setLabel("Marking of " + net.getLabel());
	...
	public Object[] connectOpenNet(Pnml pnml, OpenNet openNet) {
		/*
